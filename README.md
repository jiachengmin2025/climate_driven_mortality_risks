...
This repository supports the paper ''Mortality Forecasting under Climate Risk: A Stochastic Approach with Distributed Lag Non-Linear Models'' (published by <a href="https://doi.org/10.1093/jrsssa/qnag082">Journal of the Royal Statistical Society: Series A</a>), written by Jiacheng Min, Han Li, Thomas Nagler, and Shuanming Li. This repository contains the mortality dataset, UTCI dataset and necessary code to reproduce tables and figures in the paper.
