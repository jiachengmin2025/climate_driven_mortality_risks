---
title: "Backfitting DLNM-Lee-Carter Model: Lisbon"
author: "Jiacheng Min"
date: "`r Sys.Date()`"
output: pdf_document
---
...
expanding_window_forecast_mae <- function(set, plot_mae, validation_index) {
  # Test values (keeping "Lisbon" for data extraction)
  test_value <- set$Lisbon_test
  ...
  if (plot_mae) {
    ...
    # Replace "Lisbon" with "Lisbon" in display titles
    display_region <- "Lisbon"
...
output_plot <- grid.arrange(
  ...
  ncol = 2,  # 2 columns
  nrow = 5,  # 5 rows
  top = textGrob("B-DLNM-LC Forecasting Results for Lisbon", 
                  gp = gpar(fontsize = 14, fontface = "bold"))
)

# Save the plot with updated filename (Lisbon instead of Lisbon)
ggsave(paste0("/Users/jiachengabelmin/Desktop/LC_DLNM/Figures/Forecasts/B_DLNM_LC/Lisbon_Forecast_10_8_78.pdf"),output_plot, width = 15, height = 12, dpi = 1000)
