...
# *** Before 2D smoothing ***
load("Data/Simulation_data/UTCI/rcp85/Attiki_cb_rcp85.RData")
load("Data/Simulation_data/UTCI/rcp85/Lisbon_cb_rcp85.RData")
load("Data/Simulation_data/UTCI/rcp85/Roma_cb_rcp85.RData")
...
load("Data/Simulation_data/UTCI/rcp85/wave_list_rcp85.RData")
...
K.ts.model = kappa_fit(B_DLNM_LL_fitting, 78)
...
save(final_LL.sim.rcp85, file = "Results/Simulated_mortality_rates/final_LL_rcp85.RData")
