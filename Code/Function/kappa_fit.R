#' Fit and forecast common / region-specific kappa (K_t, k_t) from a B-DLNM-LL model
#'
#' @param B_DLNM_LL_model A fitted model object containing \code{final_LL} and \code{baseline_LL},
