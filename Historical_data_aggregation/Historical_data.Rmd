...
packages <- c("readxl", "ggplot2", "forecast", "dplyr", "gridExtra", "writexl", 
              ...
              "Metrics", "demography", "seastests", "MTS", "reshape", "dplyr",
              "tidyr", "grid", "ggpubr")
...
save(dat_list, wave_list,
     file = "/Users/jiachengabelmin/Desktop/LC_DLNM/Code/Historical_data_aggregation/Historical_data.RData")
```
...
plot_mortality <- function(data, region) {
  ggplot(data, aes(x = Time)) +
    geom_vline(xintercept = year_lines,
               ...
               color      = "gray50",
               size       = 0.3) +
    geom_line(aes(y = value, color = variable), size = 1.2, alpha = 0.8) + 
...
ggsave(
  "/Users/jiachengabelmin/Desktop/LC_DLNM/Figures/Mortality/Historical_combined.pdf",
  Mortality_plot,
  width  = 7.5,
  height = 3,
  units  = "in",
...
## Load UTCI data
```{r}
UTCI.mean = read_xlsx("/Users/jiachengabelmin/Desktop/LC_DLNM/Data/UTCI_data/Daily_data/UTCI_daily_mean.xlsx")
UTCI.max = read_xlsx("/Users/jiachengabelmin/Desktop/LC_DLNM/Data/UTCI_data/Daily_data/UTCI_daily_max.xlsx")
UTCI.min = read_xlsx("/Users/jiachengabelmin/Desktop/LC_DLNM/Data/UTCI_data/Daily_data/UTCI_daily_min.xlsx")
...
# Save the plot
ggsave(filename = "/Users/jiachengabelmin/Desktop/LC_DLNM/Figures/UTCI/Historical_UTCI.pdf",
