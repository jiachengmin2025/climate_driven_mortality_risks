...
- Start at 2020/01/01. To match the time period 2031-2045, we simulate 26 years (1352 weeks) to cover the time period for 1000 paths.
```{r}
set.seed(111)
K_sim_list = list(
...
save(final_LC.sim.rcp85, file = "/Users/jiachengabelmin/Desktop/LC_DLNM/Results/Simulated_mortality_rates/final_LC_rcp85.RData")
save(converged_LC.sim.rcp85, file = "/Users/jiachengabelmin/Desktop/LC_DLNM/Results/Simulated_mortality_rates/converged_LC_rcp85.RData")
```
